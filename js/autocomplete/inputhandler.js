...
plana.ui.ac.InputHandler.prototype.startUpdateCheckTimer_ = function() {
  this.updateTimer_ = new goog.Timer(this.updateInterval_);
...
plana.ui.ac.InputHandler.prototype.selectRow = function(row) {
  ...
  if (this.supportsMulti_) {
    ...
    this.input_.value = str.replace(this.formatRegEx_, adjustSeparators);
    sep = adjustSeparators = null;
 ...
 * @param {!numeric} interval The value to set
 */
