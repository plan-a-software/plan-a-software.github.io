(function ($) {
  ...
  TagsInput.prototype = {
    ...
    destroy: function() {
      ...
      // Unbind events
      self.$container.off();
      $.removeData(this.$container[0]);
      self.$container.remove()
      self.$container[0] = null;
      self.$container.context = null;
      ...
      self.$element.remove();
      self.$element[0] = null;
      self.$element.context = null;
      self.$element.length = 0;
      self.$element = null;

      self.options = null;
      self.$input.typeahead('destroy');
      self.$input.typeahead = null;
      
      
      self.$input.off();
      $.removeData(this.$input[0]);
      self.$input.remove();
      self.$input[0] = null;
      self.$input.context = null;
      self.$input.length = 0;
      self.$input = null;
      self = null;
    },
